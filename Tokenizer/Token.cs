namespace Hulk
{
    ...
    {
        public ComillaToken() : base(TokenName.openL, "\"", TokenType.Symbol) { }
    }
    ...
    {
        public ComaToken() : base(TokenName.closeP, ",", TokenType.Symbol) { }
    }
    ...
    {
        public EqualEqualToken() : base(TokenName.MayorEqual, "==", TokenType.Symbol) { }
    }
    ...
    {
        public OrToken() : base(TokenName.exc, "|", TokenType.Symbol) { }
    }
    public class AndToken : Token
    {
        public AndToken() : base(TokenName.exc, "&", TokenType.Symbol) { }
    }
    public class ImplicToken : Token
    {
        public ImplicToken() : base(TokenName.MayorEqual, "=>", TokenType.Symbol) { }
    }
